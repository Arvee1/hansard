...
# The UI Part
st.title("👨‍💻 Wazzup!!!! Let's Chat with the overcoming-indigenous-disadvantage-key-indicators-2020-report")
# apikey = st.sidebar.text_area("Please enter enter your API Key.")
apikey = openai_api_key
prompt = st.text_area("Please enter what you want to know from the OID Report.")
